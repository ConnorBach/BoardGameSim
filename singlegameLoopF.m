...
for gameCnt = 1:numGames
    ...
    if turnCounter == 0
        ...
        playerArray = {liberalPlayer(1,num2str(handles.p1pop.Value)),...
            ...
            tyrantPlayer(5,num2str(handles.p5pop.Value))};
        nomChance = 0;
    ...
    while numLib < 5 && numFac < 6  && hitLive == 1 && hitNom == 0; % win conditions
        ...
        for iCnt = 1:3
            if iCnt == deadPlayer || iCnt == deadPlayer2
                ...
                c = {'Liberal 1 (SELF)','Liberal 2','Liberal 3','Fascist 1','Tyrant'};
        ...
        if govPass == 1;
            ...
            if numFac > 3 && nomChance == 5; % Checks for Tyrant chancellorship after 3 fascists
                hitNom = 1;
            end
            if hitNom == 1;
...
%     labels = {'Tyrant Elected', 'Tyrant Killed', 'Card Fascist Win', 'Card Liberal Win'};
